    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (!user.IsApproved)
                {
                    ModelState.AddModelError(string.Empty, "Tài khoản của bạn chưa được duyệt bởi admin.");
                    return Page();
                }
                if (user.IsBanned)
                {
                    ModelState.AddModelError(string.Empty, "Tài khoản của bạn đã bị cấm. Hãy liên hệ admin để được gỡ lệnh cấm!");
                    return Page();
                }
